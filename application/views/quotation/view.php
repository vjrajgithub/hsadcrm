...
<div class="btn-toolbar no-print" role="toolbar">
    ...
    <div class="btn-group mr-3" role="group">
        ...
        <a href="<?php echo base_url('quotation/generate_pdf/' . (isset($quotation->id) ? $quotation->id : '1')); ?>" target="_blank" rel="noopener" class="btn btn-secondary btn-sm shadow-sm">
    ...
    <div class="btn-group" role="group">
        <button class="btn btn-warning btn-sm shadow-sm" id="sendMailBtn" data-id="<?php echo isset($quotation->id) ? $quotation->id : '1'; ?>" data-client="<?php echo isset($quotation->client_name) ? $quotation->client_name : 'Client'; ?>" data-email="<?php echo isset($quotation->client_email) ? $quotation->client_email : ''; ?>">
...
<div class="quotation-view print-content">
    ...
    <table class="info-table">
        <tr>
            ...
            <td style="width:30%;">Estimate No.<br><strong><?php echo isset($estimate_no) ? $estimate_no : ('EST-' . str_pad((isset($quotation->id) ? $quotation->id : 1), 4, '0', STR_PAD_LEFT)); ?></strong></td>
...
<script>
  ...
  // Send Mail Modal - Updated to use new enhanced modal
