...
/*
  ...
  |
 */
$config['encryption_key'] = Env_loader::get('APP_ENCRYPTION_KEY', 'aB3dF7gH9jK2mN5pQ8rS1tU4vW6xY0zA');
...
$config['csrf_exclude_uris'] = array('auth/login', 'login', 'user/ajax_save', 'auth/forgot_password', 'auth/reset_password', 'quotation/send_mail');
