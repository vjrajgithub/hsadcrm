...
class Settings extends MY_Auth_Controller {
  ...
  /**
   * Ensure the current user is Super Admin
   */
  private function require_super_admin() {
    if (strtolower($this->user_role) !== 'super admin') {
      $this->log_security_event('insufficient_privileges', ['required_role' => 'super admin']);
  ...
  public function quick_update() {
    // Only super admin can quick update settings
    $this->require_super_admin();
